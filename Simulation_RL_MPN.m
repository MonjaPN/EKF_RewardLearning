...
sim_par.simulations = 100; % agents per group
...
var_rep = zeros(max(eval_fit(:,1)),8);
...
var_rep = array2table(var_rep, 'VariableNames',{'ID','Distribution','fitted_beta_mean','simulated_beta_mean','simulated_daily_calories_mean','fitted_beta_var','simulated_beta_var','simulated_daily_calories_var'});
...
writetable(var_rep, [data_out, 'sim_betar_vars.csv'])
